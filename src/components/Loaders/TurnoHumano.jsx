...
import Plato from '../../assets/img/turnohumano.png'
...
const TurnoHumano = () => {
  return (
    ...
    >
      ...
      <p className="mt-2 lg:text-lg text-[15px] font-quicksand text-font">Ahora, turno del humano 🥳</p>
    </motion.div>
  );
};

export default TurnoHumano;